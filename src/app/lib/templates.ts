...
export const TEMPLATES: TemplateData[] = [
  { slug: "ats", name: "ATS-Optimized", keyword: "ATS resume template", tagline: "The safest choice — formatted for maximum compatibility with applicant tracking systems.", bestFor: "Anyone applying online at mid-to-large companies (Aramco, STC, banks).", accent: "#4ade80", font: "'Calibri', 'Segoe UI', Arial, sans-serif", layout: "classic", atsScore: 100, atsNote: "Single column, standard headings, zero graphics — parses cleanly in ATS software." },
