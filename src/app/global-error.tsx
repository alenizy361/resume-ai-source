...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body style={{ margin: 0, background: "#f6f7fa", color: "#171a21", fontFamily: "system-ui, -apple-system, sans-serif" }}>
        <main style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
          <div style={{ maxWidth: 460, textAlign: "center", border: "1px solid rgba(185,28,28,.28)", borderRadius: 20, padding: 32, background: "#ffffff" }}>
            <div style={{ fontSize: 28, marginBottom: 12 }}>!</div>
            <h1 style={{ fontSize: 20, margin: "0 0 8px" }}>Something went wrong</h1>
            <p style={{ fontSize: 14, lineHeight: 1.7, color: "#454c5e", margin: "0 0 6px" }}>
              Your CV is saved on this device — nothing was lost.
            </p>
            <p dir="rtl" style={{ fontSize: 14, lineHeight: 1.7, color: "#454c5e", margin: "0 0 20px" }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <a
                href="/builder"
                style={{ border: "1px solid rgba(15,20,35,.18)", color: "#171a21", borderRadius: 12, padding: "12px 20px", fontSize: 14, fontWeight: 600, textDecoration: "none" }}
              >
                Builder · المنشئ
              </a>
            </div>
            {error?.digest && (
              <p style={{ marginTop: 22, fontFamily: "ui-monospace, monospace", fontSize: 11, color: "#5d6577" }}>
                {error.digest}
              </p>
            )}
          </div>
