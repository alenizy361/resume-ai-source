  ...
  return (
    <SeoLanding
      ...
      bullets={[
        ...
        { title: "What's paid (and why)", body: `The complete rewritten resume, PDF export, and cover letter — ${formatPrice("single", "en")} (${PLANS.single.priceUsd}) once or ${formatPrice("complete", "en")} one-time. The analysis tells you exactly what you'd be paying for first.` },
      ...
      faqs={[
        { q: "Is this resume checker actually free?", a: `Yes — the score, keyword analysis, skills gap, and improvement list are free every time, with no sign-up or credit card. The complete rewritten resume is the paid part (${formatPrice("single", "en")} one-time or ${formatPrice("complete", "en")} one-time).` },
