 ...
 * the CV weaves itself line by line, and retires to a greenat the reveal.
 *
...
const T = {
  ar: {
    ...
    seo_sub: "تحدّث مع المستشار دقيقتين واحصل على سيرة تجتاز أنظمة التوظيف — مجاناً وبدون تسجيل.",
    greet: "ما مهنتك؟",
    ...
    net_fail: "انقطع الاتصال لحظة — إجابتك محفوظة. لنكمل.",
    retry: "أعد المحاولة",
    ...
    upload_fail: "تعذّرت قراءة الملف — الصق النص مباشرة.",
    ...
    updating: "أدمج الإضافات وأعيد الصياغة…",
  ...
  en: {
    ...
    seo_sub: "Talk with the Advisor for two minutes and leave with an ATS-ready resume — free, no signup.",
    ...
    land_solution: "A focused interview that writes from your words — and never invents a number",
    ...
    land_result: "A professional resume with an ATS score — in two minutes",
    ...
    net_fail: "The connection dropped — your answer is saved. Let's continue.",
    retry: "Try again",
    ...
    cv_short: "That's too short — paste your full resume.",
    goal_q: "Your resume is in. What's next?",
    goal_add: "Add experience",
    goal_tailor: "Tailor to a job",
    goal_improve: "Improve it",
    jobad_q: "Paste the job posting, or type \"skip\"",
    updating: "Merging your additions and rewriting…",
...
export default function AdvisorLanding({ lang }: { lang: Lang }) {
  ...
  // inline greenin the reveal header).
